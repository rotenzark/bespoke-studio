...
(function () {
  ...
  var I18N = {
    ...
    'camp.psy.short': { it: "Sito nuovo per uno storico negozio di dischi del Ticinese, dal 1988 (Via Zamenhof 2, 4,7/151, Fabio e Amos, «uno degli ultimi baluardi della musica di qualità a Milano», LP/7\"/CD nuovo+usato, rock e sottogeneri, no sito solo FB/Discogs). Struttura unica: 1° sito NERO/punk del progetto; gesto-firma «Il cartellino» (l'etichetta del disco con pressing+condizione+prezzo, pratica reale del negozio) + estetica gig-poster DIY (ticker, wordmark gigante) + eventi in-store. Nero + osso + rosa Psycho (autentico dal logo/pareti) + blu elettrico, Big Shoulders Display + Space Grotesk + DM Mono. 4 foto reali (facciata, interno rosa, insegna). Diverso da Dischivolanti (45 giri). 6° del Blocco 4, 1° negozio di dischi.", en: "A brand-new site for a historic Ticinese record shop, since 1988 (Via Zamenhof 2, 4.7/151, Fabio and Amos, «one of the last bastions of quality music in Milan», LP/7\"/CD new+used, rock and subgenres, no site, only FB/Discogs). A unique structure: the project's 1st BLACK/punk site; the signature «the tag» (the record's label with pressing+condition+price, the shop's real practice) + a DIY gig-poster aesthetic (ticker, giant wordmark) + in-store events. Black + bone + Psycho pink (authentic, from the logo/walls) + electric blue, Big Shoulders Display + Space Grotesk + DM Mono. 4 real photos (storefront, pink interior, sign). Different from Dischivolanti (the 7\"). The 6th build of Block 4, the 1st record shop.", },
    'camp.psy.open':  { it: 'Apri il sito di Psycho in una nuova scheda', en: 'Open the Psycho website in a new tab' },
    'camp.mido.short': { it: "Restyle per uno storico ristorante arabo del Ticinese, dal 1990 (Via Pietro Custodi 4, 4,4/460, famiglia Nassar, «il primo ristorante arabo all'ombra della Madonnina», tra i primi etnici d'Italia; il loro sito era in Flash, schermo nero). Struttura unica: gesto-firma l'ARCO ARABO (le nicchie della sala e i pannelli-menù, ripresi in una cornice ad arco polilobato SVG) + il menù «in tre misure» (piccolo/medio/massimo, anche veg e vegano) + la firma del couscous cotto a vapore per otto ore. Prezzi VERI letti dai pannelli-menù. Sabbia + terracotta + verde-acqua + ottone, Amiri (naskh arabo-latino) + Manrope. 7 foto reali (sale, mezze, kebab, falafel). 7° del Blocco 4 (Ticinese/Porta Romana), 1° ristorante mediorientale del progetto.", en: "A restyle for a historic Ticinese Arab restaurant, since 1990 (Via Pietro Custodi 4, 4.4/460, the Nassar family, «the first Arab restaurant in the shade of the Madonnina», among Italy's first ethnic restaurants; their site was in Flash, a black screen). A unique structure: the signature ARAB ARCH (the dining-room niches and the menu boards, echoed in an SVG multifoil-arch frame) + the menu «in three sizes» (small/medium/max, in veg and vegan versions too) + the signature couscous steamed for eight hours. REAL prices read from the menu boards. Sand + terracotta + teal + brass, Amiri (Arabic-Latin naskh) + Manrope. 7 real photos (dining rooms, mezze, kebab, falafel). The 7th build of Block 4 (Ticinese/Porta Romana), the project's 1st Middle-Eastern restaurant.", },
    'camp.mido.open':  { it: 'Apri il sito di Mido in una nuova scheda', en: 'Open the Mido website in a new tab' },
    'camp.som.short': { it: "Restyle premium per una pasticceria bottega storica di Porta Romana, dal 1919 (Via Crema 25, 4,5/187, famiglia Sommariva dal 1976, specialità gli Amaretti Morbidi di Porta Romana; il loro sito era un template datato con splash «ENTER»). Struttura unica: estetica «Premiata Pasticceria» (etichetta heritage, cornice a doppio filetto) + le tre epoche 1919 (Gina Grandi) → 1976 (Giorgio & Teresa) → oggi (Gianluca & Ivan) + le onorificenze come medaglie (Bottega Storica 1919, medaglia d'oro alla Scala 2008, Gambero Rosso 2015) + la specialità l'amaretto morbido. Fascia prezzi reale, citazione stampa di Luciano Pignataro. Crema + verde bottiglia + amaretto + oro medaglia, Fraunces + Karla. 8 foto reali. 8° del Blocco 4 (Ticinese/Porta Romana), 1ª pasticceria del progetto.", en: "A premium restyle for a historic Porta Romana pasticceria, since 1919 (Via Crema 25, 4.5/187, the Sommariva family since 1976, famous for its soft Amaretti di Porta Romana; their old site was a dated template with an «ENTER» splash). A unique structure: a «Premiata Pasticceria» heritage-label aesthetic (double-rule frame) + three eras 1919 (Gina Grandi) → 1976 (Giorgio & Teresa) → today (Gianluca & Ivan) + the honours as medals (Historic Shop 1919, gold medal at La Scala 2008, Gambero Rosso 2015) + the soft-amaretto speciality. Real price band, a press quote from critic Luciano Pignataro. Cream + bottle green + amaretto + medal gold, Fraunces + Karla. 8 real photos. The 8th build of Block 4 (Ticinese/Porta Romana), the project's 1st pasticceria.", },
    ...
    'camp.bele.short': { it: "Restyle per un laboratorio orafo tra Porta Romana e la Crocetta (Via Osti 6, 4,5/16, Giacomo e il figlio, un mestiere di cinquant'anni di padre in figlio, creazioni su misura + restauri + gioielli antichi; il loro sito belemilano.com era elegante ma non responsive, con testi di bozza lasciati nel live). Struttura unica: gesto-firma «AL BANCHETTO» (il banco dell'orafo) + il percorso bespoke «dal desiderio al gioiello» (idea → disegno → banchetto → gioiello) + l'eredità padre-figlio. Estetica orafo editorial luxe (foto gioielli su nero, corallo & oro), diversa dai siti scuri punk. Crema + carbone + oro + corallo, Cormorant Garamond + Jost. 7 foto reali. 9° del Blocco 4 (Ticinese/Porta Romana), 1ª gioielleria/oreficeria del progetto.", en: "A restyle for a goldsmith's workshop between Porta Romana and Crocetta (Via Osti 6, 4.5/16, Giacomo and his son, a fifty-year craft passed from father to son, bespoke creations + restoration + antique jewels; their site belemilano.com was elegant but non-responsive, with draft copy left live). A unique structure: the signature «AL BANCHETTO» (the goldsmith's bench) + the bespoke journey «from wish to jewel» (idea → sketch → bench → jewel) + the father-and-son heritage. A luxe editorial goldsmith aesthetic (jewels shot on black, coral & gold), distinct from the project's dark punk sites. Cream + charcoal + gold + coral, Cormorant Garamond + Jost. 7 real photos. The 9th build of Block 4 (Ticinese/Porta Romana), the project's 1st jeweller.", },
    'camp.bele.open':  { it: 'Apri il sito di Belè Milano in una nuova scheda', en: 'Open the Belè Milano website in a new tab' },
    'camp.col.short': { it: "Sito nuovo per una torrefazione e bar di quartiere del Ticinese (Corso San Gottardo 21, 4,3/99, di proprietà di donne, caffè tostato nel laboratorio a due passi e servito al banco, «il miglior caffè di Milano» per i clienti, no sito). Struttura unica: gesto-firma «Le miscele» (la carta delle miscele di casa — arabica dolce, africano leggero, decaffeinato — in una sezione scura, comprabili sfuse) + il percorso «dalla mattina all'aperitivo» (caffè & brioche → focacce → spritz & stuzzichini). Estetica torrefazione calda (slab serif, tazzine e latte art), diversa dai locali eleganti/scuri. Latte + espresso + tostato + rosso caffè + ottone, Bitter + Onest. 7 foto reali. 10° del Blocco 4 (Ticinese/Porta Romana), 1ª torrefazione/caffetteria del progetto.", en: "A brand-new site for a neighbourhood coffee roastery and bar in the Ticinese (Corso San Gottardo 21, 4.3/99, woman-owned, coffee roasted in a workshop round the corner and served at the counter, «the best coffee in Milan» according to regulars, no site). A unique structure: the signature «Our blends» (the house blend card — sweet arabica, light African, decaf — in a dark section, sold loose too) + the «morning to aperitivo» journey (coffee & brioche → focacce → spritz & stuzzichini). A warm coffee-roastery aesthetic (slab serif, cups and latte art), different from the elegant/dark venues. Latte + espresso + roast + coffee red + brass, Bitter + Onest. 7 real photos. The 10th build of Block 4 (Ticinese/Porta Romana), the project's 1st coffee roastery.", },
    ...
    'camp.vig.short': { it: "Sito nuovo per un barbiere storico di Porta Vigentina, dal 1968 (Viale Beatrice d'Este 49, 4,9/192, fondato da Pino/Giuseppe Muollo, oggi gestito da tre donne — la figlia Claudia con Chantal e Alessia; no sito, solo Fresha). Struttura unica: gesto-firma «Le regole della bottega» (il codice d'altri tempi — si dà del «lei», niente pettegolezzi, la privacy è sacra, un angolo di pace, in una sezione scura) + la storia «le tre barbiere dal 1968» + la firma «barba ricamata». Estetica barbiere raffinata e calma (Newsreader serif, poltrone vintage), diversa dagli altri barbieri del campionario. Crema + bordeaux + eucalipto + ottone, Newsreader + Instrument Sans. 3 foto reali, foto-light. 11° del Blocco 4 (Ticinese/Porta Romana), 4° barbiere del progetto con gesto-firma distinto.", en: "A brand-new site for a historic Porta Vigentina barbershop, since 1968 (Viale Beatrice d'Este 49, 4.9/192, founded by Pino/Giuseppe Muollo, today run by three women — his daughter Claudia with Chantal and Alessia; no site, only Fresha). A unique structure: the signature «House rules» (an old-fashioned code — you address each other as «lei», no gossip, privacy is sacred, a corner of calm, in a dark section) + the «three women barbers since 1968» story + the signature «barba ricamata» (hand-drawn beard designs). A refined, calm barbershop aesthetic (Newsreader serif, vintage chairs), different from the other barbers in the portfolio. Cream + burgundy + eucalyptus + brass, Newsreader + Instrument Sans. 3 real photos, photo-light. The 11th build of Block 4 (Ticinese/Porta Romana), the project's 4th barber with a distinct signature.", },
    'camp.vig.open':  { it: 'Apri il sito di I Vigentini in una nuova scheda', en: 'Open the I Vigentini website in a new tab' },
    'camp.grp.short': { it: "Sito nuovo per un negozio di vintage rock & streetstyle del Ticinese, dal 2011 (Via Gian Giacomo Mora 7, 4,8/129, Alice Di Cipriani — dal banco al mercato al negozio; solo Bigcartel/IG). Struttura unica: gesto-firma «Il vintage a peso» (i due piani: 1° prezzo fisso / 2° al chilo, sulla bilancia — feature reale) + «rilavorato a mano — il pezzo unico» (Alice customizza i capi vintage in pezzi unici, ispirata dai viaggi). Estetica streetstyle bold e CHIARA (concrete + rosa Groupies + nero, font Syne), volutamente diversa dai locali scuri/punk e dalle altre moda vintage. Crema concrete + nero + rosa Groupies, Syne + Chivo. 3 foto reali, foto-light (collector inquinato da altri vintage vicini, verificate a una a una). 12° del Blocco 4 (Ticinese/Porta Romana), 4ª moda vintage con gesto-firma distinto.", en: "A brand-new site for a rock & streetstyle vintage shop in the Ticinese, since 2011 (Via Gian Giacomo Mora 7, 4.8/129, Alice Di Cipriani — from a market stall to the shop; only Bigcartel/IG). A unique structure: the signature «Vintage by the kilo» (the two floors: 1st fixed price / 2nd sold by weight, on the scale — a real feature) + «remade by hand — the one-of-a-kind piece» (Alice customises vintage garments into unique pieces, inspired by her travels). A bold, LIGHT streetstyle aesthetic (concrete + Groupies pink + black, Syne type), deliberately different from the dark/punk venues and the other vintage shops. Concrete cream + black + Groupies pink, Syne + Chivo. 3 real photos, photo-light (the collector was polluted with nearby vintage shops, verified one by one). The 12th build of Block 4 (Ticinese/Porta Romana), the 4th vintage-fashion shop with a distinct signature.", },
    'camp.grp.open':  { it: 'Apri il sito di Groupies Vintage in una nuova scheda', en: 'Open the Groupies Vintage website in a new tab' },
    'camp.gil.short': { it: "Sito nuovo per una rosticceria/salumeria/gastronomia di famiglia in Corso Italia, dal 1968 (Corso Italia 33, 4,7/51, Elena l'ha aperta nel 1968 e si alza alle 6 per cucinare, oggi col figlio Alessandro al banco; solo IG). Struttura unica: gesto-firma «Il menù del giorno» (la lavagna dei piatti pronti che cambia ogni giorno, resa come vera lavagna scritta a mano) + la storia Elena & Alessandro e «la Milano di una volta». Diverso dalle altre gastronomie/salumerie del campionario (Rossi&Grassi «al banco», Cassani dialetto). Burro + rosso pomodoro + verde erba + ottone + lavagna, Spectral + Schibsted Grotesk + Caveat. 2 foto reali, foto-light (collector Maps inquinato da altre rosticcerie vicine + il sito prima, verificate a una a una). 13° del Blocco 4 (Ticinese/Porta Romana), 4ª gastronomia/salumeria con gesto-firma distinto.", en: "A brand-new site for a family rosticceria/salumeria/gastronomia on Corso Italia, since 1968 (Corso Italia 33, 4.7/51, Elena opened it in 1968 and still gets up at 6 to cook, today with her son Alessandro at the counter; only IG). A unique structure: the signature «Today's menu» (the blackboard of ready dishes that changes daily, rendered as a real hand-written chalkboard) + the Elena & Alessandro story and «the Milan of a gentler time». Different from the other delis/gastronomie in the portfolio (Rossi&Grassi «at the counter», Cassani Milanese dialect). Butter + tomato red + herb green + brass + chalkboard, Spectral + Schibsted Grotesk + Caveat. 2 real photos, photo-light (the Maps collector was polluted with other nearby rosticcerie + the previous site, verified one by one). The 13th build of Block 4 (Ticinese/Porta Romana), the 4th deli/gastronomia with a distinct signature.", },
