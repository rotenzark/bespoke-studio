...
(function () {
  ...
  var I18N = {
    ...
    'camp.cpi.short': { it: "Libreria d'arte a Porta Romana, allestita come una galleria dalla storica dell'arte Michela. Gesto-firma: il senso del nome (la stanza-opera di Mantegna) + i libri scelti «come opere». Crema+salvia+bordeaux, Prata+EB Garamond.", en: "An art bookshop in Porta Romana, set up like a gallery by art historian Michela. Signature: the meaning of the name (Mantegna's room-as-artwork) and books chosen “like works of art”. Cream + sage + burgundy, Prata + EB Garamond.", },
    'camp.cpi.open':  { it: 'Apri il sito de La Camera Picta in una nuova scheda', en: 'Open the La Camera Picta website in a new tab' },
    'camp.bgt.short': { it: "Calzolaio e artigiano del cuoio in Via Orti (Porta Romana): risuola e restaura scarpe, borse e cinture, e crea pelletteria a mano. Gesto-firma «el bagatt» + la doppia «si ripara / si crea». Cuoio+cognac, Fraunces+DM Mono.", en: "A cobbler and leather artisan in Via Orti (Porta Romana): resoles and restores shoes, bags and belts, and makes leather goods by hand. Signature: “el bagatt” + the “repaired / handmade” duality. Leather + cognac, Fraunces + DM Mono.", },
    ...
    'camp.mu.short': { it: "Enoteca e whiskeria a Conciliazione: ~200 vini e ~100 whisky. Concept sulla dualità del nome — il malto (whisky/birre) e l'uva (vino) che si incontrano nel «&», il grande bancone. Dark elegante, Bodoni Moda.", en: "A wine and whisky bar at Conciliazione: ~200 wines and ~100 whiskies. A concept on the duality of the name — the malt (whisky/beer) and the grape (wine) meeting at the «&», the big counter. Dark and elegant, Bodoni Moda.", },
    'camp.mu.open': { it: "Apri il sito de Il Malto e l'Uva in una nuova scheda", en: "Open the Il Malto e l'Uva website in a new tab", },
    'camp.ab.short': { it: "La birreria pre-stadio a 300 metri da San Siro: birre alla spina, popcorn con ogni birra, Elvis & Irisild. Concept «prima di San Siro» col brindisi del loro logo, poster matchday in Anton. Il vecchio business.site era morto col 404.", en: "The pre-match pub 300 metres from San Siro: beers on tap, popcorn with every beer, Elvis & Irisild. A «before San Siro» concept with the toast from their logo, matchday poster in Anton. Their old business.site was dead with a 404.", },
    'camp.ab.open': { it: "Apri il sito di All Beer in una nuova scheda", en: "Open the All Beer website in a new tab", },
    'camp.sv.short': { it: "L'enoteca di quartiere di San Siro col vino sfuso «come una volta»: dal Piave al Piemonte, un litro a pochi euro, su lavagna. Concept caldo dall'insegna reale (Caveat + DM Serif) e Alessandro l'oste. Il vecchio business.site era morto col 404.", en: "The neighbourhood wine shop in San Siro with bulk wine «like the old days»: from Piave to Piemonte, a litre for a few euros, on a chalkboard. A warm concept from their real sign (Caveat + DM Serif) and Alessandro the host. Their old business.site was dead with a 404.", },
    ...
    'camp.mc.short': { it: "La macelleria dei tre fratelli del trapanese al Mercato Wagner, da tre generazioni. Concept editoriale «dal trapanese al Mercato Wagner» con la firma di famiglia — i «messinesi» — e la reputazione di «miglior macelleria di Milano». Heritage siteless (Bevan slab).", en: "The three Trapani-born brothers’ butcher at Mercato Wagner, for three generations. An editorial concept «from the Trapani area to Mercato Wagner» with the family signature — the «messinesi» — and a reputation as «the best butcher in Milan». Siteless heritage (Bevan slab).", },
    'camp.mc.open': { it: "Apri il sito della Macelleria F.lli Catalano in una nuova scheda", en: "Open the Macelleria F.lli Catalano website in a new tab", },
    'camp.pa.short': { it: "La pizzeria storica di Corso Vercelli, dal 1960: la pizza al trancio milanese, in un locale «fermo agli anni '80». Concept vintage rosso (Alfa Slab One) dalla loro insegna reale, coi verbatim «la migliore di Milano». Heritage siteless (solo Facebook).", en: "The historic pizzeria on Corso Vercelli, since 1960: Milanese pizza by the slice, in a place «stuck in the ’80s». A vintage red concept (Alfa Slab One) from their real sign, with the «best in Milan» verbatims. Siteless heritage (Facebook only).", },
    ...
    'camp.ot.short': { it: "La birreria-pub fronte Stadio San Siro: HB München e Tennent's alla spina, panini fatti al momento, la partita su Sky e i concerti. Concept dark matchday col gesto-firma «a qualsiasi ora» — la giornata del pub (colazione → aperitivo → la partita → notte) col momento corrente acceso in tempo reale. ⚠️ Concept ribaltato dalla doppia-verifica (l'ippodromo del prospecting non è confermato). Il difetto: il sito è un WordPress fermo al copyright 2015.", en: "The beer-house pub in front of Stadio San Siro: HB München and Tennent's on tap, sandwiches made to order, the match on Sky and the concerts. A dark matchday concept with the «any time» signature — the pub's day (breakfast → aperitivo → the match → night) with the current moment lit in real time. ⚠️ Concept overturned by on-screen re-checking (the prospecting's racetrack angle isn't confirmed). The flaw: the site is a WordPress stuck at the 2015 copyright.", },
    'camp.ot.open': { it: "Apri il sito dell'Old Tenconi Pub in una nuova scheda", en: "Open the Old Tenconi Pub website in a new tab", },
    'camp.fc.short': { it: "La merceria storica di Piazza De Angeli, dal 1965: bottoni gioiello, passamanerie, pizzi, filati e lane. Concept caldo col gesto-firma «SI TROVA TUTTO» — la caverna del merciaio: un ticker-inventario che non finisce mai e il motivo-bottone. Bitter+Hanken Grotesk, carta e rosso-filo. Restyle dal template Italiaonline con foto stock. ⚠️ Concept su selezione/heritage/competenza (recensioni polarizzate: nessun claim sulla cortesia).", en: "The historic haberdashery of Piazza De Angeli, since 1965: jewel buttons, trimmings, lace, yarns and wool. A warm concept with the «FIND EVERYTHING» signature — the haberdasher's cave: a never-ending inventory ticker and the button motif. Bitter+Hanken Grotesk, paper and thread-red. A restyle of the stock-photo Italiaonline template. ⚠️ Concept built on selection/heritage/expertise (polarised reviews: no claim on courtesy).", },
    'camp.fc.open': { it: "Apri il sito di Foderami Castelli in una nuova scheda", en: "Open the Foderami Castelli website in a new tab", },
    'camp.ad.short': { it: "La frutteria-café ibrida di Piazzale Segesta: frutta e verdura che diventano frullati, centrifughe, crêpes e colazione — tra piante e fiori, col dehor. Concept fresco botanico col gesto-firma «PIÙ DI UNA FRUTTERIA» (le sei anime + motivo-foglia) e «Adelaide» in corsivo come il neon reale. Sacramento+Fraunces+Nunito Sans, crema/verde/pesca. ⚠️ Prospect siteless (solo Facebook); concept sull'ibrido verificato (storia nonna e «gelateria» non confermate).", en: "The hybrid greengrocer-café of Piazzale Segesta: fruit and veg that turn into smoothies, juices, crêpes and breakfast — among plants and flowers, with a terrace. A fresh botanical concept with the «MORE THAN A GREENGROCER» signature (the six souls + leaf motif) and «Adelaide» in script like the real neon sign. Sacramento+Fraunces+Nunito Sans, cream/green/peach. ⚠️ Siteless prospect (Facebook only); concept built on the verified hybrid (the grandmother story and «gelato» claim aren't confirmed).", },
    'camp.ad.open': { it: "Apri il sito di Adelaide in una nuova scheda", en: "Open the Adelaide website in a new tab", },
    'camp.sm.short': { it: "La classica pasticceria di quartiere di Via San Siro: brioche alla crema, bignè, i krapfen del weekend, le torte su ordinazione (Chantilly e frutti di bosco). Concept caldo col gesto-firma «LA MATTINA DEL QUARTIERE» — la pasticceria-rituale del mattino (aperta solo 07:30-13, chiusa il lunedì). Playfair Display+Mulish, crema/crimson/oro. Prospect siteless (solo IG/FB): tutta l'identità vive sui social.", en: "The classic neighbourhood pastry shop of Via San Siro: cream brioche, choux buns, the weekend krapfen, cakes to order (Chantilly and berries). A warm concept with the «THE NEIGHBOURHOOD'S MORNING» signature — the morning-ritual pastry shop (open only 7:30am-1pm, closed Mondays). Playfair Display+Mulish, cream/crimson/gold. Siteless prospect (Instagram/Facebook only): the whole identity lives on social.", },
    'camp.sm.open': { it: "Apri il sito della Pasticceria Santa Maria in una nuova scheda", en: "Open the Pasticceria Santa Maria website in a new tab", },
